...
1.) File sharing is the practice of sharing files or folders on a network, either publicly or privately. It allows multiple people to use the same file data. File sharing can be used to distribute digital media such as documents, computer programs, multimedia, or electronic books. File share permissions control who can access shared folders, subfolders, and files over a network. They do not apply to users who access the files locally

<img src="https://i.imgur.com/u2cxsb2.png" height="50%" width="50%" alt="Create some sample file shares"/>  
